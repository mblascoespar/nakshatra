 ...
 * Each entry has: id, name, category
 */
export const ACTIVITIES = [
  { id: 1, name: "Art", category: "Creative" },
  { id: 2, name: "Arson", category: "Ritual/Tantric" },
  { id: 3, name: "Astronomy", category: "Learning" },
  { id: 4, name: "Breaking alliances", category: "Conflict" },
  { id: 5, name: "Building", category: "Property" },
  { id: 6, name: "Buying home", category: "Property" },
  { id: 7, name: "Careers", category: "Professional" },
  { id: 8, name: "Ceremonies", category: "Spiritual" },
  { id: 9, name: "Creativity", category: "Creative" },
  { id: 10, name: "Dance", category: "Creative" },
  { id: 11, name: "Day-to-day works", category: "Daily" },
  { id: 12, name: "Deceit", category: "Ritual/Tantric" },
  { id: 13, name: "Deity", category: "Spiritual" },
  { id: 14, name: "Destruction", category: "Conflict" },
  { id: 15, name: "Education", category: "Learning" },
  { id: 16, name: "Emotional healing", category: "Healing" },
  { id: 17, name: "Evil schemes", category: "Ritual/Tantric" },
  { id: 18, name: "Gardening", category: "Agriculture" },
  { id: 19, name: "Invocation of spirits", category: "Ritual/Tantric" },
  { id: 20, name: "Laying foundations", category: "Property" },
  { id: 21, name: "Learning astrology", category: "Learning" },
  { id: 22, name: "Learning dance", category: "Learning" },
  { id: 23, name: "Learning music", category: "Learning" },
  { id: 24, name: "Long-term goals", category: "Goals" },
  { id: 25, name: "Luxury", category: "Leisure" },
  { id: 26, name: "Marriage", category: "Life Events" },
  { id: 27, name: "Medical", category: "Health" },
  { id: 28, name: "Music", category: "Creative" },
  { id: 29, name: "Personal growth", category: "Spiritual" },
  { id: 30, name: "Permanent things", category: "Goals" },
  { id: 31, name: "Planting ghosts", category: "Ritual/Tantric" },
  { id: 32, name: "Pleasure", category: "Leisure" },
  { id: 33, name: "Procession", category: "Social" },
  { id: 34, name: "Professional responsibilities", category: "Professional" },
  { id: 35, name: "Real estate", category: "Property" },
  { id: 36, name: "Release emotions", category: "Healing" },
  { id: 37, name: "Research", category: "Creative" },
  { id: 38, name: "Relationships", category: "Life Events" },
  { id: 39, name: "Routine duties", category: "Daily" },
  { id: 40, name: "Sales", category: "Business" },
  { id: 41, name: "Self-development", category: "Spiritual" },
  { id: 42, name: "Separations", category: "Conflict" },
  { id: 43, name: "Sex", category: "Leisure" },
  { id: 44, name: "Sowing", category: "Agriculture" },
  { id: 45, name: "Spiritual", category: "Spiritual" },
  { id: 46, name: "Sports", category: "Recreation" },
  { id: 47, name: "Starting business", category: "Business" },
  { id: 48, name: "Starting industries", category: "Business" },
  { id: 49, name: "Studying medicine", category: "Learning" },
  { id: 50, name: "Surgery", category: "Health" },
  { id: 51, name: "Tantric", category: "Ritual/Tantric" },
  { id: 52, name: "Terminate employee", category: "Conflict" },
  { id: 53, name: "Terminate relationship", category: "Conflict" },
  { id: 54, name: "Trade", category: "Business" },
  { id: 55, name: "Travel", category: "Travel" },
  { id: 56, name: "Vedas", category: "Learning" },
  { id: 57, name: "Vehicles", category: "Travel" },
  { id: 58, name: "War", category: "Conflict" },
  { id: 59, name: "Will", category: "Legal" },
];
...
export const ACTIVITY_CATEGORIES = {
  "Business & Commerce": [40, 47, 48, 54], // Sales, Starting business, Starting industries, Trade
